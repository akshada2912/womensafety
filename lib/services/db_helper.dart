...
class DatabaseHelper {
  ...
  /*static Future<void> InsertImg() async {
    final db = await _getDB();
    return await db.execute("INSERT INTO User (SELECT * FROM OPENROWSET(BULK N'{FILE_TO_LOAD}', SINGLE_BLOB) AS Image) WHERE curruser=1");
  }
*/
